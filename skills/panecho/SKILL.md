...
Current release: **panecho-v0.64.16.2** — Developer ID signed (Browserstack Inc, Team `YQ5FZQ855D`) + notarized + stapled. Latest: https://github.com/xxshubhamxx/cmux-panecho/releases/latest
...
Before editing `cmux.json`, copy it to a timestamped `.bak` next to it so the user can revert. Schema (tracks upstream cmux, identical for Panecho): `https://raw.githubusercontent.com/xxshubhamxx/cmux-panecho/panecho-v0.64.16.2/web/data/cmux.schema.json`.
